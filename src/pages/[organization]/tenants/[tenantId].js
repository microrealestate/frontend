...
const Tenant = withTranslation()(
  observer(({ t }) => {
    ...
    const [openConfirmDeleteTenant, setOpenConfirmDeleteTenant] =
      useState(false);
              ...
              <Tooltip
                title={
                  store.tenant.selected.hasPayments
                    ? t(
                        'This tenant cannot be deleted because some payments have been recorded.'
                      )
                    : ''
                }
              >
      ...
      >
          ...
          {!!store.tenant.selected.properties && (
            <Hidden smDown>
              <Grid item md={4}>
                ...
                <DashboardCard Icon={ReceiptIcon} title={t('Rental')}>
                  <RentOverview />
                </DashboardCard>
              </Grid>
            </Hidden>
        ...
        >
          ...
          <Box py={2}>
            <Typography variant="body2">
              {t(
                'Modifying this information might break the contract signed with the tenant.'
              )}
            </Typography>
          </Box>
          <Typography variant="body2">{t('Continue editing?')}</Typography>
        </ConfirmDialog>
        <ConfirmDialog
        ...
        >
          <Box display="flex" alignItems="center">
            ...
            <Typography variant="h6">
              {t('Are you sure to definitely remove this tenant?')}
            </Typography>
          </Box>
          <Box py={2}>
